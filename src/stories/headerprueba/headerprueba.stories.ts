...
import { HeaderComponent } from './headerprueba.component';
...
const meta: Meta<HeaderComponent> = {
  ...
  component: HeaderComponent,
   decorators: [
    moduleMetadata({
      imports: [CommonModule,BrowserAnimationsModule,MatMenuModule], // Usa CommonModule aquí
    }),
  ],
  tags: ['autodocs'],
  ...
  render: (args) => ({
    ...
    <!-- fIN BUSCADOR -->
      <span class="ms-auto header-buttons-group">
         <!--Aplicaciones-->
        <button [matMenuTriggerFor]="menu" class="btn header-button button-apps " aria-label="Módulos" title="Módulos"> 
